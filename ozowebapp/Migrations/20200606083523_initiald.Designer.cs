...
namespace ozowebapp.Migrations
{
    ...
    [Migration("20200606083523_initiald")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ozowebapp.Models.ArhivaNatjecajToOprema", b =>
                {
                    b.Property<int>("ArhivaNatjecajToOpremaID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ArhivaNatjecajToOpremaID");

                    b.HasIndex("ArhivaNatjecajClassID");

                    b.HasIndex("OpremaClassID");

                    b.ToTable("ArhivaNatjecajToOpremas");
                });

            modelBuilder.Entity("ozowebapp.Models.ArhivaNatjecajToZanimanje", b =>
                {
                    b.Property<int>("ArhivaNatjecajToZanimanjeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ArhivaNatjecajToZanimanjeID");

                    b.HasIndex("ArhivaNatjecajClassID");

                    b.HasIndex("ZanimanjeClassID");

                    b.ToTable("ArhivaNatjecajToZanimanjes");
                });
            ...
            modelBuilder.Entity("ozowebapp.Models.ArhivaNatjecajToOprema", b =>
                {
                    b.HasOne("ozowebapp.Models.ArhivaNatjecajClass", "ArhivaNatjecajClass")
                        .WithMany("ArhivaNatjecajToOpremas")
                        .HasForeignKey("ArhivaNatjecajClassID")
            ...
            modelBuilder.Entity("ozowebapp.Models.ArhivaNatjecajToZanimanje", b =>
                {
                    b.HasOne("ozowebapp.Models.ArhivaNatjecajClass", "ArhivaNatjecajClass")
                        .WithMany("ArhivaNatjecajToZanimanjes")
                        .HasForeignKey("ArhivaNatjecajClassID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
